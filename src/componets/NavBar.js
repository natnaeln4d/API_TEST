...
export default function NavBar() {
  return (
    <div>
         <nav className="flex flex-wrap items-center justify-between border shadow sm:p-2 dark:bg-gray-800">
  <div className="flex items-center flex-shrink-0 mr-6 text-white">
    ...
    <span className="text-xl font-semibold tracking-tight">Car Dealer</span>
  </div>
  ...
  <div className="flex-grow block w-full lg:flex lg:items-center lg:w-auto">
    <div className="text-sm lg:flex-grow">
      ...
      <a href="#responsive-header" className="block mt-4 ml-2 text-teal-200 lg:inline-block lg:mt-0 hover:text-white">
        Home
